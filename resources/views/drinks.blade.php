					...
					<ul class="navbar-nav ">
					  ...
					  <li class="nav-item dropdown">
						...
						<ul class="dropdown-menu">
						  <li><a class="dropdown-item" href="/sushirolls">Суши и роллы</a></li>
				...
				<div class="row">
					...
					<div class="col-md-4">
						<div class="card mb-4" data-id="01">
							...
							<div class="card-body text-center">
								<h4 class="item-title">Морс домашний Клюква</h4>
								<p class="pb-4"><small data-items-in-box class="text-muted">Вода питьевая, клюква, сахар</small></p>
								...
								<div class="details-wrapper">
									...
									<div class="price">
										<div class="price__weight">0.5 л</div>
										<div class="price__currency">100 ₽</div>
									</div>
								</div>
					...
					<div class="col-md-4">
						<div class="card mb-4" data-id="02">
							<img class="product-img" src="/img/menu/drinks/2.png" alt="">
							<div class="card-body text-center">
								<h4 class="item-title">Морс домашний Клюква-малина</h4>
								<p class="pb-4"><small data-items-in-box class="text-muted">вода питьевая, малина, клюква, сахар-песок</small></p>
					...
					<div class="col-md-4">
						<div class="card mb-4" data-id="03">
							<img class="product-img" src="/img/menu/drinks/3.png" alt="">
							<div class="card-body text-center">
								<h4 class="item-title">Морс домашний Лесные ягоды</h4>
								<p class="pb-4"><small data-items-in-box class="text-muted">вода питьевая, клюква, черника, ежевика, брусника</small></p>
								...
								<div class="details-wrapper">
									...
									<div class="price">
										<div class="price__weight">0.5 л</div>
										<div class="price__currency">130 ₽</div>
									</div>
