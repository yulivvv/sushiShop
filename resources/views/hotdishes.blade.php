...
<body>
	...
	<header class="header">
		...
		<div class="container">
			...
			<p class="lead">Меню > Горячие блюда</p>
		</div>
	</header>
<main>
	<div class="container mb-5">
				...
				<div class="row">
					...
					<div class="col-lg-4">
						<div class="card lg-4" data-id="01">
							...
							<div class="card-body text-center">
								<h4 class="item-title">Крем-суп грибной с шампиньонами</h4>
								<p class="pb-4"><small data-items-in-box class="text-muted">Грибной бульон, шампиньоны, сливки, репчатый лук, картофель, растительное масло, соль, чёрный</small></p>
					...
					<div class="col-lg-4">
						<div class="card mb-4" data-id="02">
							<img class="product-img" src="/img/menu/hotdishes/2.png" alt="">
							<div class="card-body text-center">
								<h4 class="item-title">Крем-суп сырный с лососем</h4>
								<p class="pb-4"><small data-items-in-box class="text-muted">Овощной бульон, лосось, плавленый сыр, сливки, морковь, репчатый лук, картофель</small></p>
					...
					<div class="col-lg-4">
						<div class="card mb-4" data-id="03">
							<img class="product-img" src="/img/menu/hotdishes/3.png" alt="">
							<div class="card-body text-center">
								<h4 class="item-title">Суп Том-кха с курицей</h4>
								<p class="pb-4"><small data-items-in-box class="text-muted">куриный бульон, паста "Том-кха", кокосовое молоко, кунжутное масло, копчёная курица, шампиньоны</small></p>
