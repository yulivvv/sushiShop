		...
		<div class="row">
			<div class="col-md-12">
				<div class="row">
					...
					<div class="col-md-4">
						<div class="card mb-4" data-id="01">
							...
							<div class="card-body text-center">
								<h4 class="item-title">Суши и роллы</h4>
								
										
								
									<button data-cart type="button" class="btn btn-block btn-outline-warning " onclick="document.location='sushirolls.html'">Перейти</button>
					...
					<div class="col-md-4">
						<div class="card mb-4" data-id="01">
							<img class="product-img" src="img/menu/sets/1.png" alt="">
							<div class="card-body text-center">
								<h4 class="item-title">Сеты</h4>
								
										
								
									<button data-cart type="button" class="btn btn-block btn-outline-warning " onclick="document.location='sets.html'">Перейти</button>
					...
					<div class="col-md-4">
						<div class="card mb-4" data-id="01">
							<img class="product-img" src="img/menu/pizzas/1.png" alt="">
							<div class="card-body text-center">
								<h4 class="item-title">Пицца</h4>
								
										
								
									<button data-cart type="button" class="btn btn-block btn-outline-warning " onclick="document.location='pizzas.html'">Перейти</button>
					...
					<div class="col-md-4">
						<div class="card mb-4" data-id="01">
							<img class="product-img" src="img/menu/hotdishes/1.png" alt="">
							<div class="card-body text-center">
								<h4 class="item-title">горячие блюда</h4>
								
										
								
									<button data-cart type="button" class="btn btn-block btn-outline-warning " onclick="document.location='hotdishes.html'">Перейти</button>
					...
					<div class="col-md-4">
						<div class="card mb-4" data-id="01">
							<img class="product-img" src="img/menu/drinks/1.png" alt="">
							<div class="card-body text-center">
								<h4 class="item-title">Напитки</h4>
								
										
								
									<button data-cart type="button" class="btn btn-block btn-outline-warning " onclick="document.location='drinks.html'">Перейти</button>
