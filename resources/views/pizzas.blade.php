				...
				<div class="row">
					...
					<div class="col-lg-4">
						<div class="card lg-4" data-id="01">
							...
							<div class="card-body text-center">
								<h4 class="item-title">Сырные с ветчиной</h4>
								<p class="pb-4"><small data-items-in-box class="text-muted">Тесто, соус «Ранч», сыр моцарелла, ветчина, соус «Песто»</small></p>
					...
					<div class="col-lg-4">
						<div class="card mb-4" data-id="02">
							<img class="product-img" src="/img/menu/pizzas/2.png" alt="">
							<div class="card-body text-center">
								<h4 class="item-title">Сырные палочки</h4>
								<p class="pb-4"><small data-items-in-box class="text-muted">тесто, чесночный соус, сыр моцарелла, сыр пармезан</small></p>
								...
								<div class="details-wrapper">
									...
									<div class="price">
										<div class="price__weight"></div>
										<div class="price__currency">550 ₽</div>
									</div>
								</div>
					...
					<div class="col-lg-4">
						<div class="card mb-4" data-id="03">
							<img class="product-img" src="/img/menu/pizzas/3.png" alt="">
							<div class="card-body text-center">
								<h4 class="item-title">Пицца Цыпа</h4>
								<p class="pb-4"><small data-items-in-box class="text-muted">тесто, сметанный соус, копчёная курица</small></p>
								...
								<div class="details-wrapper">
									...
									<div class="price">
										<div class="price__weight"></div>
										<div class="price__currency">530 ₽</div>
									</div>
