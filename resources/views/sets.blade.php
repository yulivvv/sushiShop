				...
				<div class="row">
					...
					<div class="col-lg-4">
						<div class="card lg-4" data-id="01">
							...
							<div class="card-body text-center">
								<h4 class="item-title">Сет 1</h4>
								<p class="pb-4"><small data-items-in-box class="text-muted">Ролл с лососем 1/2 , ролл с тунцом 1/2 , ролл с угрём 1/2, ролл с креветкой 1/2</small></p>
					...
					<div class="col-lg-4">
						<div class="card mb-4" data-id="02">
							<img class="product-img" src="/img/menu/sets/2.png" alt="">
							<div class="card-body text-center">
								<h4 class="item-title">Сет 2</h4>
					...
					<div class="col-lg-4">
						<div class="card mb-4" data-id="03">
							<img class="product-img" src="/img/menu/sets/3.png" alt="">
							<div class="card-body text-center">
								<h4 class="item-title">Сет 3</h4>
								...
								<div class="details-wrapper">
									...
									<div class="price">
										<div class="price__weight"></div>
										<div class="price__currency">1230 ₽</div>
									</div>
